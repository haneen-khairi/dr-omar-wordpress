 <section class="home__medicine p-r o-h" data-kira-timeline>
     <div class="container ta-c">
         <h2 class="home__medicine__title title-xxl tt-u mb-md md-up-mb-xl">
             <?php
                ...
                echo $title ? esc_html($title) : 'Title not found';
                ?>
         </h2>
     </div>

     <?php $repeater_sentences = get_field('repeater_sentences', 'section_home_medicine'); ?>
     <?php if ($repeater_sentences): ?>
     ...
     <?php $repeater_sentences_bottom = get_field('repeater_sentences_bottom', 'section_home_medicine'); ?>
     <?php if ($repeater_sentences_bottom): ?>
     ...
     <div class="home__medicine__bottom container p-r">
         <?php $bottom_sections = get_field('bottom_sections', 'section_home_medicine'); ?>
         <?php if ($bottom_sections): ?>
