    ...
    <section class="home__surgery ta-c p-r c-white">
        <div class="container">
            ...
            <div class="row">
                ...
                ?>
                <?php
                $surgery_group_key = "surgeries_4";
                if (!empty($surgeries_section[$surgery_group_key])):
                    $surgery4 = $surgeries_section[$surgery_group_key];
