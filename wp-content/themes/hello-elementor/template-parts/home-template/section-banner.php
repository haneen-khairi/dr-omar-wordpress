    ...
    <?php while (have_rows('home_hero_section')) : the_row(); ?>
        <section class="home__hero c-white hero p-r">
            <div class="home__hero__bg hero__bg bg-img absolute-full" data-kira-item="parallaxTop"
                data-bg="<?php the_sub_field('background_image'); ?>"
                data-bg-hidpi="<?php the_sub_field('background_image'); ?>"></div>
            <div class="home__hero__top hero__top hero__section d-f ai-center jc-center p-r ta-c"
                ...
                <div class="container">
                    ...
                    <a class="home__hero__link btn" href="<?php the_sub_field('button_link'); ?>" data-kira-item="fadeInUp"
                        data-start="-=1.15"><?php the_sub_field('button_text'); ?></a>
                </div>
            </div>
